...
public class FullscreenActivity extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (lejohet[0]) {
                    ...
                    Toast.makeText(FullscreenActivity.this, "Error: Nuk i keni dhene te drejta aplikacionit per ti lexuar te dhenat nga telefoni!", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (pinkodet.size() != 0) {
                    if (lejohet[1]) {
                        ...
                        Toast.makeText(FullscreenActivity.this, "Error: Nuk e keni lejuar aplikacionin te beje thirrje!", Toast.LENGTH_LONG).show();
                } else
                    Toast.makeText(FullscreenActivity.this, "Se pari selektoni fajllin me pinkode!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    protected void testPinkodin() {
        for (int i = 0; i < pinkodet.size(); i++) {
            ...
            handler.postDelayed(dialNumberRunnable, i * 15000);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (lejohet[2]) write();
                            ...
                            Toast.makeText(FullscreenActivity.this, "Error: Nuk e keni lejuar aplikacionin qe te shkruaje ne memorje!", Toast.LENGTH_LONG).show();
                    }
                }, (i + 1) * 15000);
        }
    }
